...
|------|------|----|------|---------|-------------------|
| 1 | Godot project, domain, save, unit tests | PR 1 | GUT pass | Editor play | project/project.godot, scripts/domain, save_repository.gd, tests/unit |
...
- [ ] 1.1 Create project/project.godot portrait + autoloads.
- [ ] 1.2 Create project/export_presets.cfg Android profiles.
- [ ] 1.3 Create scripts/services/scene_router.gd autoload.
- [ ] 1.4 Create placeholder scenes for all flow screens.
- [ ] 1.5 Add Godot .gitignore for imports, builds, user data.

## Phase 2: Core Domain and Persistence (TDD)

- [ ] 2.1 RED: tests for CaseDefinition categories and operators.
- [ ] 2.2 GREEN: scripts/domain/case_definition.gd.
- [ ] 2.3 RED: tests for solver uniqueness and murderer determinism.
- [ ] 2.4 GREEN: scripts/domain/case_solver.gd.
- [ ] 2.5 RED: tests for CaseState propagation and undo.
- [ ] 2.6 GREEN: scripts/domain/case_state.gd.
- [ ] 2.7 RED: tests for SaveRepository.
- [ ] 2.8 GREEN: save_repository.gd.
